...
(after! php
  ...
  (setq php-mode-program "/nix/store/6p0m2jb3zm9l7x821lp52b1k94zjmg2q-php-with-extensions-8.3.3/bin/php")
  )

  (setq dap-php-debug-program '("/nix/store/6p0m2jb3zm9l7x821lp52b1k94zjmg2q-php-with-extensions-8.3.3/bin/php" "-dxdebug.remote_enable=1" "-dxdebug.remote_mode=req" "-dxdebug.remote_port=9000" "-dxdebug.remote_host=127.0.0.1" "-dxdebug.remote_connect_back=0")
  )
